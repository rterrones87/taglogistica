<template>
    ...
    <div class="m-4 bg-white p-4 rounded shadow-md">
        ...
        <div class="flex items-center">
            <h2 class="text-3xl my-4 font-bold grow text-center md:text-left">Llantas</h2>
        ...
        <router-link class="float-button block md:hidden" :to="{ path: 'tire' }"></router-link>
        ...
        <DataTable
            ...
            :columns="columns"
            :onReload="loadItems"
            emptyMessage="No hay llantas disponibles."
        >
